...
const galleryImages = [
  {
    src: "src/img/gallery-list/photo1.jpg",
    alt: "Фото 1",
  },
  {
    src: "src/img/gallery-list/photo2.jpg",
    alt: "Фото 2",
  },
  {
    src: "src/img/gallery-list/photo3.jpg",
    alt: "Фото 3",
  },
  {
    src: "src/img/gallery-list/photo4.jpg",
    alt: "Фото 4",
  },
  {
    src: "src/img/gallery-list/photo5.jpg",
    alt: "Фото 5",
  },
];
...
turnNextButton.addEventListener("click", function () {
  ...
  if (selectedIndex + 1 < imgs.length) {
    offset =
      offset -
      imgs[selectedIndex].width / 2 -
      gap -
      imgs[selectedIndex + 1].width / 2;
    selectedIndex += 1;
  } else {
    offset = 0;
